...
"""
Script to run all regify examples with detailed reporting.
"""
...
class ExampleRunner:
    ...
    def run_all_examples(self) -> None:
        """Runs all examples."""
        print("🚀 Starting execution of all regify examples")
        print("=" * 60)
        print()
    ...
    def generate_report(self) -> None:
        ...
        if failed:
            ...
            print("   - You can use regify with confidence")

        if len(successful) > 0:
            print("   - Check the successful examples to learn how to use regify")
